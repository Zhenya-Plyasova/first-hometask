...
export function noteMarkup(note) {
    const archiveIconClass = note.isArchived ? 'active' : 'archived';
    const activeIconClass = note.isArchived ? 'archived' : 'active';
